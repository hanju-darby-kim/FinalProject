...
<script>
	...
	function addcategory(){
		var child = window.open("${pageContext.request.contextPath}/admin/curriculum/categoryadd.action", "child", "width=450, height=600, left=" + (screen.availWidth * 0.6) + ", top=" + (screen.availHeight * 0.2));
	};
