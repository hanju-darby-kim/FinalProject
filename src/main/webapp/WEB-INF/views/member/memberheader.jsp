		...
		<ul class="nav navbar-nav navbar-right">
			<li class="dropdown active"><a href="#" class="dropdown-toggle"
				...
				<ul class="dropdown-menu" role="menu">
					...
					<li><a href="index-v1_dark-header.html">개요</a></li>
					<li><a href="index-v1_light-footer.html">CEO컬럼</a></li>
					<li><a href="index-v2.html">연혁</a></li>
					<li><a href="index-v2_dark-header.html">시설 및 장비</a></li>
					<li><a href="index-v3.html">교수진 소개</a></li>
					<li><a href="index-v4_fullscreen.html">입학안내</a></li>
					<li><a href="index-v5_fullscreen_slider.html">수상현황</a></li>
					<li><a href="index-v5_fullscreen_slider.html">찾아오시는 길</a></li>
				</ul></li>
			<li class="dropdown "><a href="#" class="dropdown-toggle"
				data-toggle="dropdown">취업교육과정 <i class="fa fa-angle-down"></i></a>
				<ul class="dropdown-menu" role="menu">
					<li><a href="#">프로그래밍 과정</a></li>
					<li><a href="#">데이터베이스 과정</a></li>
					<li><a href="#">스마트폰 과정</a></li>
				</ul></li>
			<li class="dropdown "><a href="#" class="dropdown-toggle"
